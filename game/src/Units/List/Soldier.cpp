...
:Unit(pos, ID, team)
{
    ...
    for (int i=6; i>0; i--)
    {
        m_rectTexture[i] = sf::IntRect(1+i*32, 101, 30, 28);
    }

    m_rectTexture[10] = sf::IntRect(66, 160, 23, 31);
    m_rectTexture[11] = sf::IntRect(41, 160, 21, 33);
    m_rectTexture[12] = sf::IntRect(0, 166, 41, 27);
